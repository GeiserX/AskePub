...
def w_extract_html(url, get_all):
    ...
    if get_all:
        ...
        documentId = soup.find("input", {"name": "xid"}).get("value")
        ...
        return title, base_text, summary, questions, documentId, articleId, q_map
    else:
        return title, articleId, articleN

if __name__ == "__main__":
    w_extract_html("https://place.holder/html/", True)